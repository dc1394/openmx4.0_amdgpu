...
private::solve_tridi_col_double
private::solve_tridi_single_problem_double
private::solve_tridi_col_double_impl
private::solve_tridi_single_problem_double_impl
private::merge_systems_double
private::v_add_s_double
private::distribute_global_column_double
private::solve_secular_equation_double
interface hh_transform_real
procedure::hh_transform_real_double
end interface
interface elpa_reduce_add_vectors_real
procedure::elpa_reduce_add_vectors_real_double
end interface
interface elpa_transpose_vectors_real
procedure::elpa_transpose_vectors_real_double
end interface
contains
subroutine elpa_transpose_vectors_real_double(obj,vmat_s,ld_s,comm_s,vmat_t,ld_t,comm_t,nvs,nvr,nvc,nblk,nrthreads)
integer(4),intent(in)::obj
integer(4),intent(in)::ld_s
integer(4),intent(in)::nvc
real(8),intent(in)::vmat_s(1_8:int(ld_s,kind=8),1_8:int(nvc,kind=8))
integer(4),intent(in)::comm_s
integer(4),intent(in)::ld_t
real(8),intent(inout)::vmat_t(1_8:int(ld_t,kind=8),1_8:int(nvc,kind=8))
integer(4),intent(in)::comm_t
integer(4),intent(in)::nvs
integer(4),intent(in)::nvr
integer(4),intent(in)::nblk
integer(4),intent(in)::nrthreads
end
subroutine elpa_reduce_add_vectors_real_double(obj,vmat_s,ld_s,comm_s,vmat_t,ld_t,comm_t,nvr,nvc,nblk,nrthreads)
integer(4),intent(in)::obj
integer(4),intent(in)::ld_s
integer(4),intent(in)::nvc
real(8),intent(in)::vmat_s(1_8:int(ld_s,kind=8),1_8:int(nvc,kind=8))
...
subroutine solve_tridi_double(obj,na,nev,d,e,q,ldq,nblk,matrixcols,mpi_comm_rows,mpi_comm_cols,usegpu,wantdebug,success,max_threads)
integer(4),intent(in)::obj
integer(4),intent(in)::na
integer(4),intent(in)::nev
real(8),intent(inout)::d(1_8:int(na,kind=8))
real(8),intent(inout)::e(1_8:int(na,kind=8))
integer(4),intent(in)::ldq
real(8),intent(inout)::q(1_8:int(ldq,kind=8),1_8:*)
integer(4),intent(in)::nblk
...
subroutine solve_tridi_col_double(obj,na,nev,nqoff,d,e,q,ldq,nblk,matrixcols,mpi_comm_rows,usegpu,wantdebug,success,max_threads)
integer(4),intent(in)::obj
integer(4)::na
integer(4)::nev
integer(4)::nqoff
...
recursive subroutine solve_tridi_single_problem_double(obj,nlen,d,e,q,ldq,wantdebug,success)
integer(4),intent(in)::obj
integer(4)::nlen
...
subroutine solve_tridi_double_impl(obj,na,nev,d,e,q,ldq,nblk,matrixcols,mpi_comm_rows,mpi_comm_cols,usegpu,wantdebug,success,max_threads)
integer(4),intent(in)::obj
integer(4),intent(in)::na
integer(4),intent(in)::nev
real(8),intent(inout)::d(1_8:int(na,kind=8))
...
subroutine solve_tridi_col_double_impl(obj,na,nev,nqoff,d,e,q,ldq,nblk,matrixcols,mpi_comm_rows,usegpu,wantdebug,success,max_threads)
integer(4),intent(in)::obj
integer(4)::na
integer(4)::nev
integer(4)::nqoff
...
recursive subroutine solve_tridi_single_problem_double_impl(obj,nlen,d,e,q,ldq,wantdebug,success)
integer(4),intent(in)::obj
integer(4)::nlen
real(8)::d(1_8:int(nlen,kind=8))
real(8)::e(1_8:int(nlen,kind=8))
...
subroutine merge_systems_double(obj,na,nm,d,e,q,ldq,nqoff,nblk,matrixcols,mpi_comm_rows,mpi_comm_cols,l_col,p_col,l_col_out,p_col_out,npc_0,npc_n,usegpu,wantdebug,success,max_threads)
integer(4),intent(in)::obj
integer(4),intent(in)::na
...
integer(4),intent(in)::ldq
real(8),intent(inout)::q(1_8:int(ldq,kind=8),1_8:*)
integer(4),intent(in)::nqoff
integer(4),intent(in)::nblk
integer(4),intent(in)::matrixcols
integer(4),intent(in)::mpi_comm_rows
integer(4),intent(in)::mpi_comm_cols
integer(4),intent(in)::l_col(1_8:int(na,kind=8))
integer(4),intent(in)::p_col(1_8:int(na,kind=8))
integer(4),intent(in)::l_col_out(1_8:int(na,kind=8))
integer(4),intent(in)::p_col_out(1_8:int(na,kind=8))
integer(4),intent(in)::npc_0
integer(4),intent(in)::npc_n
logical(4),intent(in)::usegpu
logical(4),intent(in)::wantdebug
logical(4),intent(out)::success
integer(4),intent(in)::max_threads
end
subroutine v_add_s_double(obj,v,n,s)
integer(4),intent(in)::obj
integer(4)::n
real(8)::v(1_8:int(n,kind=8))
real(8)::s
end
subroutine distribute_global_column_double(obj,g_col,l_col,noff,nlen,my_prow,np_rows,nblk)
integer(4),intent(in)::obj
integer(4)::nlen
...
subroutine solve_secular_equation_double(obj,n,i,d,z,delta,rho,dlam)
integer(4),intent(in)::obj
integer(4)::n
integer(4)::i
...
subroutine hh_transform_real_double(obj,alpha,xnorm_sq,xf,tau,wantdebug)
integer(4),intent(in)::obj
