...
contains
subroutine compute_hh_trafo_real_openmp_double(obj,usegpu,wantdebug,a,a_dev,stripe_width,a_dim2,stripe_count,max_threads,l_nev,a_off,nbw,max_blk_size,bcast_buffer,bcast_buffer_dev,hh_dot_dev,hh_tau_dev,kernel_flops,kernel_time,n_times,off,ncols,istripe,my_thread,thread_width,kernel)
...
real(8)::bcast_buffer(1_8:int(nbw,kind=8),1_8:int(max_blk_size,kind=8))
integer(8)::bcast_buffer_dev
integer(8)::hh_dot_dev
