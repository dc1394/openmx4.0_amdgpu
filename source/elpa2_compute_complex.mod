...
use elpa1_compute_complex,only:hh_transform_complex
use elpa1_compute_complex,only:elpa_reduce_add_vectors_complex
use elpa1_compute_complex,only:elpa_transpose_vectors_complex
use elpa1_compute_complex,only:elpa_transpose_vectors_complex_double
use elpa1_compute_complex,only:elpa_reduce_add_vectors_complex_double
use elpa1_compute_complex,only:hh_transform_complex_double
...
use redist_complex,only:redist_band_complex_double
use pack_unpack_cpu_complex,only:pack_row_complex_cpu_openmp_double
use pack_unpack_cpu_complex,only:unpack_row_complex_cpu_openmp_double
use compute_hh_trafo_complex,only:compute_hh_trafo_complex_openmp_double
use mpi,only:operator(.eq.)
use,intrinsic::__fortran_builtins,only:operator(.eq.)
use mpi_types,only:operator(.eq.)
use mpi,only:operator(.ne.)
use,intrinsic::__fortran_builtins,only:operator(.ne.)
use mpi_types,only:operator(.ne.)
private::output_unit
private::error_unit
private::pcol
private::prow
...
private::hh_transform_complex
private::elpa_reduce_add_vectors_complex
private::elpa_transpose_vectors_complex
private::elpa_transpose_vectors_complex_double
private::elpa_reduce_add_vectors_complex_double
private::hh_transform_complex_double
private::mpi_status
private::mpi_comm
...
private::free
private::redist_band_complex_double
private::pack_row_complex_cpu_openmp_double
private::unpack_row_complex_cpu_openmp_double
private::compute_hh_trafo_complex_openmp_double
private::herm_matrix_allreduce_double
...
private::operator(.ne.)
contains
subroutine bandred_complex_double(obj,na,a_mat,a_dev,lda,nblk,nbw,matrixcols,numblocks,mpi_comm_rows,mpi_comm_cols,tmat,tmat_dev,wantdebug,usegpu,success,max_threads)
integer(4),intent(in)::obj
integer(4)::na
integer(4)::lda
complex(8)::a_mat(1_8:int(lda,kind=8),1_8:*)
integer(8)::a_dev
integer(4)::nblk
integer(4)::nbw
...
complex(8)::tmat(1_8:int(nbw,kind=8),1_8:int(nbw,kind=8),1_8:*)
integer(8)::tmat_dev
...
subroutine herm_matrix_allreduce_double(obj,n,a,lda,ldb,comm)
integer(4),intent(in)::obj
integer(4)::n
integer(4)::lda
integer(4)::ldb
complex(8)::a(1_8:int(lda,kind=8),1_8:int(ldb,kind=8))
integer(4)::comm
end
subroutine trans_ev_band_to_full_complex_double(obj,na,nqc,nblk,nbw,a_mat,a_dev,lda,tmat,tmat_dev,q_mat,q_dev,ldq,matrixcols,numblocks,mpi_comm_rows,mpi_comm_cols,usegpu)
integer(4),intent(in)::obj
integer(4)::na
integer(4)::nqc
integer(4)::nblk
...
integer(8)::tmat_dev
integer(4)::ldq
complex(8)::q_mat(1_8:int(ldq,kind=8),1_8:*)
integer(8)::q_dev
integer(4)::matrixcols
integer(4)::numblocks
integer(4)::mpi_comm_rows
...
subroutine tridiag_band_complex_double(obj,na,nb,nblk,a_mat,a_dev,lda,d,e,matrixcols,hh_trans,mpi_comm_rows,mpi_comm_cols,communicator,usegpu,wantdebug,nrthreads)
integer(4),intent(in)::obj
integer(4),intent(in)::na
integer(4),intent(in)::nb
integer(4),intent(in)::nblk
integer(4),intent(in)::lda
complex(8),intent(in)::a_mat(1_8:int(lda,kind=8),1_8:*)
integer(8)::a_dev
real(8),intent(out)::d(1_8:int(na,kind=8))
real(8),intent(out)::e(1_8:int(na,kind=8))
integer(4),intent(in)::matrixcols
complex(8),allocatable,intent(out)::hh_trans(:,:)
...
subroutine trans_ev_tridi_to_band_complex_double(obj,na,nev,nblk,nbw,q,q_dev,ldq,matrixcols,hh_trans,mpi_comm_rows,mpi_comm_cols,wantdebug,usegpu,max_threads,success,kernel)
integer(4),intent(in)::obj
integer(4),intent(in)::na
