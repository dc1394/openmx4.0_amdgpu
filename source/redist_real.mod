!mod$ v1 sum:ecd38de0f82889a1
module redist_real
contains
subroutine redist_band_real_double(obj,a_mat,a_dev,lda,na,nblk,nbw,matrixcols,mpi_comm_rows,mpi_comm_cols,communicator,ab,usegpu)
integer(4),intent(in)::obj
integer(4),intent(in)::lda
integer(4),intent(in)::matrixcols
real(8),intent(in)::a_mat(1_8:int(lda,kind=8),1_8:int(matrixcols,kind=8))
integer(8)::a_dev
