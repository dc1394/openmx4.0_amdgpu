...
contains
subroutine compute_hh_trafo_complex_openmp_double(obj,usegpu,wantdebug,a,a_dev,stripe_width,a_dim2,stripe_count,max_threads,l_nev,a_off,nbw,max_blk_size,bcast_buffer,bcast_buffer_dev,hh_tau_dev,kernel_flops,kernel_time,n_times,off,ncols,istripe,my_thread,thread_width,kernel)
...
integer(4),intent(in)::a_dim2
integer(4),intent(in)::stripe_count
integer(4),intent(in)::max_threads
integer(4),intent(in)::l_nev
integer(4),intent(in)::a_off
integer(4),intent(in)::nbw
integer(4),intent(in)::max_blk_size
complex(8)::bcast_buffer(1_8:int(nbw,kind=8),1_8:int(max_blk_size,kind=8))
integer(8)::bcast_buffer_dev
integer(8)::hh_tau_dev
integer(8)::kernel_flops
real(8),intent(inout)::kernel_time
integer(4)::n_times
integer(4)::off
integer(4)::ncols
integer(4)::istripe
