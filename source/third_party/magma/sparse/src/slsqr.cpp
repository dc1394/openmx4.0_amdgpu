/*
    -- MAGMA (version 2.9.0) --
       ...
       @generated from sparse/src/zlsqr.cpp, normal z -> s, Wed Jan 22 14:42:43 2025
*/
    ...
    magma_queue_t queue )
{
    ...
    CHECK( magma_smtransposeconjugate( A, &AT, queue ) );
    ...
    magma_scopy( m, r.dval, 1, u.dval, 1, queue );
