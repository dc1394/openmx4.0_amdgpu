/*
    -- MAGMA (version 2.9.0) --
       ...
       @generated from sparse/blas/zilu.cpp, normal z -> s, Wed Jan 22 14:42:18 2025
*/
    ...
    magma_queue_t queue )
{
    ...
    magma_smtransposeconjugate( precond->L, &(precond->LT), queue );
    magma_smtransposeconjugate( precond->U, &(precond->UT), queue );
