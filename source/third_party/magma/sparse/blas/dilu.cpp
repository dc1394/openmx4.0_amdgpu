/*
    -- MAGMA (version 2.9.0) --
       ...
       @generated from sparse/blas/zilu.cpp, normal z -> d, Wed Jan 22 14:42:18 2025
*/
    ...
    magma_queue_t queue )
{
    ...
    magma_dmtransposeconjugate( precond->L, &(precond->LT), queue );
    magma_dmtransposeconjugate( precond->U, &(precond->UT), queue );
