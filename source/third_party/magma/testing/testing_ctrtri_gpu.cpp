/*
    -- MAGMA (version 2.9.0) --
       ...
       @generated from testing/testing_ztrtri_gpu.cpp, normal z -> c, Wed Jan 22 14:40:27 2025
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if(opts.version == 1) {
                ...
                magma_ctrtri_expert_gpu_work( opts.uplo, opts.diag, N, NULL, ldda, &info, NULL, lwork_host, NULL, lwork_device, queues );
