/*
    -- MAGMA (version 2.9.0) --
       ...
       @generated from src/zgetrf_gpu.cpp, normal z -> s, Wed Jan 22 14:39:09 2025
...
/***************************************************************************//**
    Purpose
    -------
    magma_sgetrf_gpu_recommend_cpu returns true if magma_sgetrf_gpu is going to
...
/***************************************************************************//**
    Purpose
    -------
    magma_sgetrf_native_recommend_notrans returns true if magma_sgetrf_native is going to
    ...
    magma_event_t events[2], magma_queue_t queues[2] )
{
    ...
    lddat = (m == n) ? ldda : maxn;
    if (mode == MagmaHybrid) {
        if ( magma_sgetrf_gpu_recommend_cpu(m, n, nb) ) {
    ...
    *info = 0;
    ...
    if ( mode == MagmaHybrid && magma_sgetrf_gpu_recommend_cpu(m, n, nb) ) {
    ...
    if ( mode == MagmaNative && magma_sgetrf_native_recommend_notrans(m, n, nb) ) {
