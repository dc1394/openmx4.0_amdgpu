/*
    -- MAGMA (version 2.9.0) --
       ...
       @generated from src/ztrtri_gpu.cpp, normal z -> c, Wed Jan 22 14:39:07 2025
    ...
    magma_queue_t queues[2] )
{
    ...
    magma_int_t h_workspace_bytes = nb*nb*sizeof(magmaFloatComplex);
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_ctrtri_expert_gpu_work( uplo, diag, n, NULL, ldda, info, NULL, lwork_host, NULL, lwork_device, queues );
