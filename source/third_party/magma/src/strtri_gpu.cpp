/*
    -- MAGMA (version 2.9.0) --
       ...
       @generated from src/ztrtri_gpu.cpp, normal z -> s, Wed Jan 22 14:39:06 2025
    ...
    magma_queue_t queues[2] )
{
    ...
    magma_int_t h_workspace_bytes = nb*nb*sizeof(float);
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_strtri_expert_gpu_work( uplo, diag, n, NULL, ldda, info, NULL, lwork_host, NULL, lwork_device, queues );
