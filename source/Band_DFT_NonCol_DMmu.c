...
/* GPU CuSolver context for Band_DFT_NonCol_DMmu (added by H.Kawai, Phase D) */
typedef struct {
    int                device_id;
    cublasHandle_t     cublas;
    cusolverDnHandle_t cusolver;
} BandNonColDMmuCuSolverCtx;

static BandNonColDMmuCuSolverCtx BandNonColDMmu_cusolver_ctx = {0};

static void BandNonColDMmu_CuSolver_Destroy(void)
{
    BandNonColDMmuCuSolverCtx *ctx = &BandNonColDMmu_cusolver_ctx;
...
#pragma acc host_data use_device(A, B, C)
    {
        ...
        wait_cudafunc(openmx_gemmul8Zgemm(BandNonColDMmu_cusolver_ctx.cublas, transa, transb, m, n, k, &alpha,
