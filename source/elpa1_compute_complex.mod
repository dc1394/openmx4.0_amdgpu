...
procedure::hh_transform_complex_double
end interface
interface elpa_reduce_add_vectors_complex
procedure::elpa_reduce_add_vectors_complex_double
end interface
interface elpa_transpose_vectors_complex
procedure::elpa_transpose_vectors_complex_double
end interface
contains
subroutine elpa_transpose_vectors_complex_double(obj,vmat_s,ld_s,comm_s,vmat_t,ld_t,comm_t,nvs,nvr,nvc,nblk,nrthreads)
integer(4),intent(in)::obj
integer(4),intent(in)::ld_s
integer(4),intent(in)::nvc
complex(8),intent(in)::vmat_s(1_8:int(ld_s,kind=8),1_8:int(nvc,kind=8))
integer(4),intent(in)::comm_s
integer(4),intent(in)::ld_t
complex(8),intent(inout)::vmat_t(1_8:int(ld_t,kind=8),1_8:int(nvc,kind=8))
...
subroutine elpa_reduce_add_vectors_complex_double(obj,vmat_s,ld_s,comm_s,vmat_t,ld_t,comm_t,nvr,nvc,nblk,nrthreads)
integer(4),intent(in)::obj
integer(4),intent(in)::ld_s
integer(4),intent(in)::nvc
complex(8),intent(in)::vmat_s(1_8:int(ld_s,kind=8),1_8:int(nvc,kind=8))
...
subroutine hh_transform_complex_double(obj,alpha,xnorm_sq,xf,tau,wantdebug)
integer(4),intent(in)::obj
