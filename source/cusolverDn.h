...
typedef enum {
    HIPSOLVER_EIG_RANGE_ALL = 1001,
    HIPSOLVER_EIG_RANGE_V = 1002,
    HIPSOLVER_EIG_RANGE_I = 1003
} cusolverEigRange_t;
...
#define CUSOLVER_STATUS_ARCH_MISMATCH 4
#define CUSOLVER_STATUS_MAPPING_ERROR 5
#define CUSOLVER_STATUS_EXECUTION_FAILED 6
#define CUSOLVER_STATUS_INTERNAL_ERROR 7
#define CUSOLVER_STATUS_MATRIX_TYPE_NOT_SUPPORTED 8
#define CUSOLVER_STATUS_NOT_SUPPORTED 9
#define CUSOLVER_STATUS_ZERO_PIVOT 10
#define CUSOLVER_STATUS_INVALID_LICENSE 11
#define CUSOLVER_STATUS_INVALID_WORKSPACE 12
