/*****************************************************************************
  ...
  for recent developments.
    ...
    **************************************************************
     ...
     Present (15/April/2026) official address
...
{ 
  ...
  ****************************************************/
  ...
  if ( strcmp(argv[1],"-maketestCWF")==0){
  ...
  ****************************************************/
  ...
  if ( strcmp(argv[1],"-maketestNEGF")==0){
  ...
  *********************************************************************/
  ...
  if ( strcmp(argv[1],"-maketestCDDF")==0){
  ...
  *********************************************************************/
  ...
  if ( strcmp(argv[1],"-maketestDCLNO")==0){
